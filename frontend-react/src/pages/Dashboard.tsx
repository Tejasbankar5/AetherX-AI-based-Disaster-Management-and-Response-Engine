...
export default function Dashboard() {
    ...
    return (
        <div className="flex min-h-screen flex-col bg-background relative overflow-hidden bg-grid dark pt-24">
            {/* Background Decorative Elements */}
            {/* Background Decorative Elements */}
            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-violet-900/10 via-background to-background pointer-events-none" />
